...
::: {.path-logo}
[![](files/images/logos/ensta.svg){fig-alt="ENSTA logo"}](https://www.ensta.fr/)
:::

::: {.path-content}
### ENSTA Paris

<p class="path-role">Postdoctoral Researcher in experimental aerodynamics.</p>
...
::: {.linked-experience}
::: {.linked-logo}
[![](files/images/logos/ugr.svg){fig-alt="Universidad de Granada logo"}](https://www.ugr.es/)
:::
...
Experimental campaigns and collaboration linked to wind-tunnel measurements and aerodynamic analysis.
:::
:::

::: {.linked-experience}
::: {.linked-logo}
[![](files/images/logos/iista.svg){fig-alt="IISTA logo"}](https://iista.es/)
:::

::: {.linked-body}
<span class="linked-date">PhD period</span>

##### IISTA

Research activity at the Instituto Interuniversitario de Investigación del Sistema Tierra en Andalucía, associated with Universidad de Granada.
:::
:::
...
Experimental campaigns and research collaboration connected to doctoral work, including wind-tunnel measurements and aerodynamic analysis.
:::

::: {.footprint-item}
<span class="footprint-item-year">PhD period</span>
...
Courses related to experimental methods, vehicle aerodynamics, data analysis, safety, instrumentation, or research software can be grouped here.
:::
...
Certifications, licenses, and formal credentials can be listed with issuer, date, and a short note on relevance.
:::
:::
